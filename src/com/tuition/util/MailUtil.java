...
public class MailUtil {
   ...
   // public static String receiveMailAccount = "xiaoxiaolePlus@163.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, long random,String receiveMail,String userName) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "修改密码验证码", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, userName+"先生/女士", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("您正在修改密码，验证码为：");
